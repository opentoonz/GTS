...
void iip_scale_by_subpixel::_exec_ushrt( unsigned short *ushrtp_in, unsigned short *ushrtp_out, long l_out_width, long l_out_height, long l_out_channels, long l_x_subpixel, long l_y_subpixel, long *lp_width, long *lp_height, long *lp_scanline )
{
	long	l_xy_subpixel;
	long	xx,yy,zz,xs,ys;
	long	*lp_w,
		*lp_scan;
	unsigned short	*ushrtp_in_x;
