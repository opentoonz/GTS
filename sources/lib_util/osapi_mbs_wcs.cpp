...
int main(int argc, char *argv[])
{
	...
	std::wcout << L"mbs->wcs   =\"" << wcs << L"\"" << std::endl;

	std::string  mbs( osapi::mbs_from_wcs( wcs ) );
	std::cout << "wcs->mbs   =\"" << mbs << "\"" << std::endl;
...
cl /W4 /WX /MD /EHa /O2 /wd4819 /DUNICODE /DDEBUG_RSRC_MBS_WCS osapi_mbs_wcs.cpp /Fea_u16
cl /W4 /WX /MD /EHa /O2 /wd4819 /DDEBUG_RSRC_MBS_WCS osapi_mbs_wcs.cpp /Fea_u08
